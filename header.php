...
<div id="page" class="hfeed site">
    ...
    <div id="site-logo">
					<img src="http://localhost/wp/test/wp-content/uploads/sites/2/2017/06/main-logo-e1498329510631.png"/>
    </div>
			<?php 
            ...
            <a href="https://en.wikipedia.org/wiki/RSS" target="_blank" ><i class="fa fa-rss"></i></a>
        </div>
		</nav><!-- #site-navigation -->
		</div>
